# Compile win-embed-v10.c into win-embed-v10.exe
$vcvarsPath = "C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\VC\Auxiliary\Build\vcvarsall.bat"
$sourceFile = "D:\ObsidianPlugin\obsidian-onenote-integration\win-embed-v10.c"
$outputExe = "D:\ObsidianPlugin\obsidian-onenote-integration\win-embed-v10.exe"
