# Compile win-embed-position-v2.c into win-embed-v6.exe
$vcvarsPath = "C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\VC\Auxiliary\Build\vcvarsall.bat"
$sourceFile = "D:\ObsidianPlugin\obsidian-onenote-integration\win-embed-position-v2.c"
$outputExe = "D:\ObsidianPlugin\obsidian-onenote-integration\win-embed-v6.exe"
